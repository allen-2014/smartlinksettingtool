...
import com.sola.smartlinksettingtool.R;
...
public class ProgressWheel extends View {
    ...
    //rotating speed by the whole circle bar
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (String line : splitText) {
        	String line0 = line.substring(0, line.length() - 1);
            float horizontalTextOffset = textPaint.measureText(line0) / 2;
            canvas.drawText(
            		line0,
                    ...
                    textPaint);
            //
            //draw the last charater
            float newLineWidth = textPaint.measureText(line0);
            String str = line.substring(line.length() - 1);
            
            textPaint.setTextSize(textSize / 2);
            canvas.drawText(
            		str,
                    this.getWidth() / 2 - horizontalTextOffset + newLineWidth,
                    this.getHeight() / 2,
                    textPaint);
            textPaint.setTextSize(textSize);
